                    ...
                    <div class="box-body">
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label>Nama</label> 
                                <input type="text" name="nama" placeholder="Nama Travel" value="<?= $d->nama ?>"  class="input-control" required>
                            </div>

                            <div class="form-group">
                                <label>Email</label> 
                                <input type="email" name="email" placeholder="Email Travel" value="<?= $d->email ?>"  class="input-control" required>
                            </div>

                            <div class="form-group">
                                <label>Telepon</label> 
                                <input type="text" name="telp" placeholder="Telepon Travel" value="<?= $d->telepon ?>"  class="input-control" required>
                            </div>
                            ...
                            <div class="form-group">
                                <label>Favicon</label>
                                <img src="../uploads/identitas/<?= $d->favicon ?>"width="42" class="image">
                    ...
                    if(isset($_POST['submit'])){
                        ...
                        if($_FILES['logo_baru']['name'] !=''){
                            ...
                            if(!in_array($formatfile_logo,$allowedtype_logo)){
                                ...
                                echo '<div class="alert alert-error">Format file logo travel tidak diizinkan.</div';

                                return false;

                            }elseif($filesize_logo > 1000000 ){

                                echo '<div class="alert alert-error">Ukuran file logo travel tidak boleh lebih dari 1 MB.</div';
                        ...
                        $update   = mysqli_query($conn,"UPDATE pengaturan SET
                            ...
                            if($update) {
                                echo "<script>window.location='identitas-travel.php?success=Edit Data Berhasil'</script>";
                            }else{
